  ...
  actions do
    ...
    create :create do
      ...
      accept [
        ...
        :custom_field_values, :notes,
        :project_id, :parent_id, :template_task_id, :assigned_group_id
      ]
    end

    update :update do
      accept [:title, :description, :start_date, :end_date, :warning_date,
              :custom_field_values, :notes, :assigned_group_id]
